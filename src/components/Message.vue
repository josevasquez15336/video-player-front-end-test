...
<ion-item >
  <ion-textarea rows="1" placeholder="Add a comment..." auto-grow v-model="videoComment"  clear-on-edit="true">
  </ion-textarea>
</ion-item>

<ion-icon  @click="stop()" :icon="paperPlaneOutline">
</ion-icon>
</div>   
...
import {happyOutline,paperPlaneOutline, playBackOutline, playForwardOutline,playOutline, volumeMuteOutline, volumeHighOutline} from 'ionicons/icons';
